...
class CanvasDocumentEditorTest {
    ...
    fun moveBlockReordersTheRequestedBlock() {
        val first = TextBlock("1", "First", BlockAlignment.LEFT, TextBlockStyle())
        val second = TextBlock("2", "Second", BlockAlignment.LEFT, TextBlockStyle())
        val third = TextBlock("3", "Third", BlockAlignment.LEFT, TextBlockStyle())
    ...
    fun removeBlockFallsBackToDefaultDocumentWhenLastBlockIsDeleted() {
        val only = TextBlock("1", "Only", BlockAlignment.LEFT, TextBlockStyle())
